...
\begin{figure*}
  \centering
  \subfigure[the growth in the number of ASes visible to BGPStream between 2001 and 2019 ]{\includegraphics[width=.4\paperwidth]{images/num-nodes-all.pdf}}\hfill
  \subfigure[the growth in the number of entries in BGP routing tables between 2001 and 2019 \cite{CIDR-Report}]{\includegraphics[width=.4\paperwidth]{images/bgpEntries.png}}
...
\begin{figure*}
  \centering
  \subfigure[the number of ASes discovered ]{\includegraphics[width=.4\paperwidth]{images/num-nodes.pdf}}\hfill
  \subfigure[the number of connections between ASes discovered  ]{\includegraphics[width=.4\paperwidth]{images/num_edges.pdf}}\hfill
...
\begin{figure*}
  \centering
  \subfigure[the percentage of snapshots with clusters greater than 0 ]{\includegraphics[width=.4\paperwidth]{images/nodes-with-clusters.pdf}}\hfill
  \subfigure[the average cluster size of nodes that have a cluster size greater than 0 ]{\includegraphics[width=.4\paperwidth]{images/average-cluster-size.pdf}}\hfill
...
\begin{figure*}
  \centering
  \subfigure[Average shortest path length for each year using TZ routing]{\includegraphics[width=.4\paperwidth]{images/path-averages.pdf}}\hfill
  \subfigure[the average path stretch for each snapshot using TZ routing ]{\includegraphics[width=.4\paperwidth]{images/path-stretch.pdf}}\hfill
\end{figure*}
